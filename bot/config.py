...
class Config(object):
    ...
    DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://icryptobos:Uyx6wos9cNsInbjw@cluster0.uryupvp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
